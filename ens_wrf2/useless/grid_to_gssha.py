...
# Hongli edit
# reference: https://pangaea.readthedocs.io/en/latest/_modules/pangaea/read.html#open_mfdataset
...
#                                          loader=self.pangaea_loader)
            ...
            self._xd = open_mfdataset(path_to_lsm_files,
                                      lat_var=self.lsm_lat_var,
                                      lon_var=self.lsm_lon_var,
                                      time_var=self.lsm_time_var,
                                      lat_dim=self.lsm_lat_dim,
